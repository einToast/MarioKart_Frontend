...
export const getRounds = async (): Promise<RoundReturnDTO[]> => {
    try {
        const response = await axios.get<RoundReturnDTO[]>(`${API_BASE_URL}/rounds`);
...
export const getCurrentRounds = async (): Promise<RoundReturnDTO[]> => {
    try {
        const response = await axios.get<RoundReturnDTO[]>(`${API_BASE_URL}/rounds/current`);
        return response.data;
    } catch (error) {
...
export const getRoundById = async (roundId: number): Promise<RoundReturnDTO> => {
    try {
        const response = await axios.get<RoundReturnDTO>(`${API_BASE_URL}/rounds/${roundId}`);
        return response.data;
    } catch (error) {
...
export const getGamesByRoundId = async (roundId: number): Promise<GameReturnDTO[]> => {
    try {
        const response = await axios.get<GameReturnDTO[]>(`${API_BASE_URL}/rounds/${roundId}/games`);
        return response.data;
    } catch (error) {
...
export const getGames = async (): Promise<GameReturnDTO[]> => {
    try {
        const response = await axios.get<GameReturnDTO[]>(`${API_BASE_URL}/games`);
        return response.data;
    } catch (error) {
...
export const getGameById = async (gameId: number): Promise<GameReturnDTO> => {
    try {
        const response = await axios.get<GameReturnDTO>(`${API_BASE_URL}/games/${gameId}`);
        return response.data;
    } catch (error) {
...
export const getPoints = async (): Promise<PointsReturnDTO[]> => {
    try {
        const response = await axios.get<PointsReturnDTO[]>(`${API_BASE_URL}/points`);
        return response.data;
    } catch (error) {
